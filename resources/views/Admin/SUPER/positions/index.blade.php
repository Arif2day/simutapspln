...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Positions/Jabatan</h1>
    </div>
        ...
        <div class="col-xl-12 col-md-12 col-lg-12 mb-1">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Data Positions/Jabatan</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="row float-right mr-0 mb-2">
                        ...
                        <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#addPositionModal">
                            <i class="fas fa-fw fa-plus-circle"></i> Add Positions/Jabatan</button>
                    </div>
                    <div class="text-xs">
                        <table class="table positions-datatable display" style="width:100%;">
                        ...
                        <input type="hidden" id="urllist" name="urllist" value="{{url('master/positions/list')}}">
                        <input type="hidden" id="urldel" name="urldel" value="{{url('master/positions')}}">                        
                    </div>
                </div>
            </div>
        </div>
    ...
    @include('Admin.SUPER.positions.modal.add')
    @include('Admin.SUPER.positions.modal.edit')
...
<script>
    ...
    var table = $('.positions-datatable').DataTable({   
        pageLength : 25,
        dom: 'lfrtip',        
        processing: true,
        serverSide: true,
    ...
    function deletePosition(params) {
        Swal.fire({
            title: 'Yakin?',
            text: "Anda akan menghapus Data Position.",
            icon: 'warning',
    ...
    function clearEditFormPosition() {
    ...
    function savePosition() {
        ...
        if (title=="") {
            Swal.fire({icon: 'error', title: 'Oops...',text: "Title Required!",});
        }
        else{
            let datar = {};
            datar['_method']='POST';
    ...
    function updatePosition() {
        ...
        let title = $('input[id=e_title').val();        
    ...
    $(document).on('click', '.editPositionBtn', function () {
        ...
        $('#editPositionModal input[id="e_id"]').val(id);
        $('#editPositionModal input[id="e_title"]').val(title);
    });
</script>
@endsection